(()=>{
  ...
  function sacredHeartTemplate(){
    return [
      ["section","A團分部課","A","weekly","1","2026-09-01","2026-12-31","","17:40","18:30","音樂教室1、音樂教室2、A／B團練教室區（同一區域，僅隔走道）","週一"],
      ["section","A團分部課","A","weekly","3","2026-09-01","2026-12-31","","17:40","18:30","音樂教室1、音樂教室2、A／B團練教室區（同一區域，僅隔走道）","週三"],
      ["section","B團分部課","B","weekly","2","2026-09-01","2026-12-31","","17:40","18:30","音樂教室1、音樂教室2、A／B團練教室區（同一區域，僅隔走道）","週二"],
      ["section","B團分部課","B","weekly","4","2026-09-01","2026-12-31","","17:40","18:30","音樂教室1、音樂教室2、A／B團練教室區（同一區域，僅隔走道）","週四"],
      ["section","儲備團分部課","儲備","weekly","5","2026-10-02","2026-12-31","","17:10","18:30","音樂教室1、音樂教室2、A／B團練教室區（同一區域，僅隔走道）","10/2 起"],
      ...sacredEnsembleDates.flatMap(d=>[
        ["ensemble","A團合奏課","A","date","","","",d,"12:40","13:20","A／B團練教室區（同一區域，僅隔走道）","指定日期"],
        ["ensemble","B團合奏課","B","date","","","",d,"12:40","13:20","A／B團練教室區（同一區域，僅隔走道）","指定日期"]
      ]),
      ...sacredComprehensiveDates.map(d=>["comprehensive","弦樂團體活動","A,B,儲備","date","","","",d,"08:45","10:15","A／B團練教室區（同一區域，僅隔走道）、音樂教室2","固定日期"])
    ];
  }
