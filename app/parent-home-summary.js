(()=>{
  ...
  function parentMonthlyScoreCard(){
    ...
    return `<div class="parent-monthly-score">
      ...
      <small style="display:block;margin-top:8px;color:var(--muted)">計分公開：練習日期占 70%，老師月評占 30%；每日有完成自主練習紀錄即計 1 天，練習分鐘數不列入分數；多位授課老師取平均。${current?"本月進行中，目前為暫估分數。":"此月份為正式月評結果。"}</small>
    </div>`;
  }
