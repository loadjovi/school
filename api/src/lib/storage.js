...
function mappingView(e,registration=null){return {parentEmail:String(e.partitionKey||"").toLowerCase(),parentName:String(e.parentName||registration?.parentName||""),relationship:String(e.relationship||registration?.relationship||"家長"),studentId:String(e.rowKey||""),studentName:String(e.studentName||e.name||registration?.studentName||""),grade:String(e.grade||registration?.grade||""),groupName:String(e.groupName||registration?.groupName||""),instrument:String(e.instrument||registration?.instrument||""),section:String(e.section||registration?.section||"待確認"),schoolYear:String(e.schoolYear||registration?.schoolYear||""),semester:String(e.semester||registration?.semester||""),registrationId:String(e.registrationId||""),status:String(e.status||"")};}
